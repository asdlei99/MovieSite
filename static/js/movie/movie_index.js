...
$(function() {
	...
	$('#focus-bar li a:not("#more-filters")').click(function() {
		...
		window.location.href = '/'+cate+'/?focus='+fid+'&type='+tid+'&region='+rid;
	});
	...
	var $switchArrow = $('#more-filters i.fa');
	...
	var type_keywords = ['juqing','xiju','aiqing','qihuan','guzhuang','dongzuo','maoxian','kehuan',
	      	            'xuanyi','jingsong','kongbu','fanzui','zhanzheng','donghua','duanpian','jilupian',
	      	            'tongxing','qingse','jiating','ertong','lishi','yundong','zhuanji',
	      	            'tuokouxiu','zhenrenxiu','yinyue','gewu','xiqu'];
